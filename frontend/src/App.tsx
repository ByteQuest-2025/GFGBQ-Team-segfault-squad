...
import { Activity, Users, Target, TrendingUp, Eye, Settings, BarChart3, Menu, X } from 'lucide-react';

type View = 'dashboard' | 'agents' | 'campaigns' | 'audience' | 'trends' | 'analytics' | 'settings';
